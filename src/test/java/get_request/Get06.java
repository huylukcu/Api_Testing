...
public class Get06 extends HerOkuAppBaseUrl {
   ...
   */
    ...
    public void get06() {
        ...
        assertEquals(156,jsonPath.getInt("totalprice"));
        assertEquals(true,jsonPath.getBoolean("depositpaid"));
        assertEquals( "2022-12-09",jsonPath.getString("bookingdates.checkin"));
        assertEquals("2022-12-22",jsonPath.getString("bookingdates.checkout"));
        ...
        softAssert.assertEquals(jsonPath.getInt("totalprice"),156,"totalprice did not match");
